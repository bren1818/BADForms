...
<form name="theform" id="theform" method="POST" action="" enctype="multipart/form-data">
	...
	<div class="formRow">
		...
		<div class="rowField">
			...
			<?php for($sm = 0; $sm < sizeof( $encryptionMode_values); $sm++){ ?>
				<label><?php echo $encryptionMode_values[$sm]; ?>: <input type="radio" name="encryptionMode" id="encryptionMode" value="<?php echo trim($encryptionMode_values[$sm]); ?>" <?php if( ( is_object($theform) &&  $theform->getEncryptionMode() ?  $theform->getEncryptionMode()  : '') == trim($encryptionMode_values[$sm])){ echo " checked"; } ?>  required="required" /></label>
			<?php } ?>
		</div>
	</div>
	<div class="formRow">
	...
	<div class="formRow">
		...
		<div class="rowField">
			<label>(mm/dd/yyyy) <input class="dateInput" type="text" name="sunrise" id="sunrise" value="<?php echo (isset($theform) ?  $theform->getSunrise() : ''); ?>" title=" Date should be in format mm/dd/yyyy"  pattern="d{1,2}/d{1,2}/d{4}" /></label>
		</div>
	</div>
	<div class="formRow">
		<div class="rowLabel">
		...
		<div class="rowField">
			<label>(mm/dd/yyyy) <input class="dateInput" type="text" name="sunset" id="sunset" value="<?php echo (isset($theform) ?  $theform->getSunset() : ''); ?>" title=" Date should be in format mm/dd/yyyy"  pattern="d{1,2}/d{1,2}/d{4}" /></label>
		</div>
	</div>
