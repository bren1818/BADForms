...
<div class="formOptions">
    ...
    <!--
    <a class="btn" href="/views/form/formCssJs.php?codeType=1&formID=<?php echo $formID; echo $css;?>"><i class="fa fa-pencil-square-o"></i> Edit Group CSS</a>
    <a class="btn" href="/views/form/formCssJs.php?codeType=2&formID=<?php echo $formID; echo $js; ?>"><i class="fa fa-code"></i> Edit Group Javascript</a>
    -->
    <a class="btn" href="/views/group/editGroup.php?formID=<?php echo $formID; ?>"><i class="fa fa-pencil-square-o"></i> Edit Group Information</a>
    <a class="btn" href="/renderForm.php?formID=<?php echo $formID; ?>"><i class="fa fa-desktop"></i> Preview Group</a>
	...
	if( $query->execute() ){
		$theForm = $query->fetchObject("theform");
                ...
                if($theForm->getIsGroup() != 1){
                    echo "Error! You're attempting to edit a form as a group";
...
<!--
Number of times this group is used
-->
...
<a class="btn" target="_blank" href="/renderForm.php?formID=<?php echo $formID; ?>"><i class="fa fa-desktop"></i> Preview Group</a>
<?php
	pageFooter();
